...
**Problema de eficiencia: Cuantos más datos hay, el trabajo se multiplica al cuadrado. Para 50.000 partidos, necesita hacer unos 2.500 millones de operaciones. Es tan lento que el ordenador se bloquea si intentas procesar todos los datos juntos**.
